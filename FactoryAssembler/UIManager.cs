...
public class UIManager
{
    ...
    public void UpdateMainMenu(FactoryGame game)
    {
        ...
        if (Raylib.IsMouseButtonPressed(MouseButton.Left))
        {
            ...
            if (Raylib.CheckCollisionPointRec(mouse, new Rectangle(menuX, startY + 160, 400, 60))) ShowInfoPanel = true; // INFO GOMB!
    ...
    public void Draw(FactoryGame game, int screenW, int screenH, Vector2 mouseScreen)
    {
        ...
        if (GameState.Inventory["Rocket"] >= 1)
        {
            ...
            if (Raylib.IsMouseButtonPressed(MouseButton.Left) && Raylib.CheckCollisionPointRec(mouseScreen, new Rectangle(winX + 250, winY + 340, 300, 60))) {
